...
public class TodayItem extends ActivityGroup {
	...
	private TodayLuckySpider spider;
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		spider = new TodayLuckySpider(this,conn);
	...
	private void initData(int index)
	{
		...
		tv_title.setText(con_names[index] + "今日运势");
		SimpleDateFormat formatter = new SimpleDateFormat("yyyy年MM月dd日");
		Date today = new Date();
		tv_today.setText(formatter.format(today));
	...
	private String getConn(int index)
	{
		...
		case 0:
			return URLS.ARIES_1;
		case 1:
			return URLS.TAURUS_1;
		case 2:
			return URLS.GEMINI_1;
		case 3:
			return URLS.CANCER_1;
		case 4:
			return URLS.LEO_1;
		case 5:
			return URLS.VIRGO_1;
		case 6:
			return URLS.LIBRO_1;
		case 7:
			return URLS.SCORPIO_1;
		case 8:
			return URLS.SAGITTARIUS_1;
		case 9:
			return URLS.CAPRICORN_1;
		case 10:
			return URLS.AQUARIUS_1;
		case 11:
			return URLS.PISCES_1;
		}
		return URLS.ARIES_1;
	}
}
